	...
	<br>
		...
		<table width="1000" border="0" align="center" cellpadding="0" cellspacing="1">
		    ...
		    <tr>
		        ...
		        <td>
		        	<?php 
						$sql_kecamatan = mysqli_query($con, 'select * from kecamatan order by name asc');
					 ?>
					 <select class="form-control" name="kecamatan" id="kecamatan" required="">
					 	...
					 	?>
					 	<option class="form-control" value="<?php echo $row_kecamatan['id'] ?>">
					 		<?php echo $row_kecamatan['name'] ?>
					 	</option>	
					 	<?php } ?>
	                  </select><br>
		        </td>
		    ...
		    <tr>
		        ...
		        <td>
		        	<?php 
						$sql_nfaskes = mysqli_query($con, 'select * from nfaskes order by name asc');
					 ?>
					 <select class="form-control" name="nfaskes" id="faskes" required="">
					 	<option value="">Pilih Nama Faskes</option>
					 	<?php 
					 		while($row_nfaskes = mysqli_fetch_array($sql_nfaskes)){
					 	?>
					 	<option class="form-control" value="<?php echo $row_nfaskes['id'] ?>">
					 		<?php echo $row_nfaskes['name'] ?>
					 	</option>	
					 	<?php } ?>
	                  </select><br>
		        </td>
